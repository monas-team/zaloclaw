...
Connect your personal Zalo account to an AI agent with **151 actions**.
...
**Xem đầy đủ 151 actions:** [`docs/actions.md`](docs/actions.md)
...
src/
  ...
  tools/tool.ts             ← 151 action handlers
docs/
